$ ->
  ...
  renderCheckBox = (choiseNumber, QuestionNumber) ->
    ...
    <input type='button' id='delete_choise' value='削除' data-number=#{choiseNumber} data-question-number=#{questionNumber}class='append_checkbox btn btn-danger'>
    </li></ul>
  ...
  renderRadioButton = (choiseNumber, QuestionNumber) ->
    ...
    <input type='button' id='append_radio' class='append_checkbox btn btn-default' data-question-number=#{questionNumber}  value='選択肢追加'>"
